...
import hug
from database.Car_Price_Prediction import prediction_with_csv
...
@hug.get('/api/car/prediction')
def prediction_with_local_data(body):
    # Appel à la fonction prediction_with_csv() pour effectuer le traitement des données CSV
    # et obtenir le résultat de la prédiction du prix des voitures
    result = prediction_with_csv()
    # Retourne le résultat de la prédiction en tant que réponse à la requête GET
    return result
